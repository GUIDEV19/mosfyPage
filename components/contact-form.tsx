...
export default function ContactForm() {
  return (
    <section id="contato" className="py-20 px-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Entre em Contato</h2>
          <p className="text-gray-300 mb-8">
            Preencha o formulário e entraremos em contato em até 24 horas para discutir seu projeto.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-300">contato@webcraft.com.br</p>
              </div>
            </div>
          ...
          <div className="flex items-center mt-8 space-x-4">
            <a
              href="#"
              className="bg-indigo-600/20 w-10 h-10 rounded-full flex items-center justify-center text-indigo-500 hover:bg-indigo-600/30 transition-colors"
            >
